	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 4:
				...
				if (result > 300)
					System.out.println(
							"Amazing!!!Keep it up..Great!!You can get yummy snacks from AdaptiveU store..Enjoyyy");
				else if (result >= 150 && result < 300)
					System.out
							.println("Hey you crossed 150 points..Now you can get yummy snacks from AdativeU Store!!");
				else
					System.out.println(
							"You didn't reach the target!!Atleast try to score 150\n to get snacks from AdaptiveU store");
				break;
